...
<head>
  ...
  <link rel="apple-touch-icon" href="assets/images/004-cat.png">
  <meta name="apple-mobile-web-app-title" content="Flatkit">
  <!-- for Chrome on Android, multi-resolution icon of 196x196 -->
  <meta name="mobile-web-app-capable" content="yes">
  <link rel="shortcut icon" sizes="196x196" href="assets/images/004-cat.png">
      ...
      <div class="left navside dark dk" data-layout="column">
        <div class="navbar no-radius">
          ...
          <a class="navbar-brand">
            ...
            <span class="hidden-folded inline">IoT informática</span>
          </a>
          <!-- / brand -->
        </div>
          ...
          <div class="nav-fold">
            <a href="profile.html">
              <span class="pull-left">
                <img src="assets/images/icon-user.png" alt="..." class="w-40 img-circle">
              </span>
              <span class="clear hidden-folded p-x">
                <span class="block _500">Usuario 1</span>
...
<!-- build:js scripts/app.html.js div
<!-- jQuery -->
